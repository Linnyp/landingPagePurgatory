...
export function ServicesTabs() {
  ...
  return (
    <section
      ...
      className="relative z-10 border-b-4 border-sand-950 bg-sand-100 bg-grid-pattern py-28"
    >
      <div className="mx-auto w-full max-w-[1200px] px-6">
        <h2 id="services-tabs-heading" className="sr-only">
          Service overview
        </h2>
              ...
              return (
                <button
                  ...
                  className={[
                    ...
                    // dividers — right border on every tab except last in its row
                    !isLastInRow ? "border-r-2 border-sand-950" : "",
                    "lg:border-r-2 lg:last:border-r-0",
                    // bottom border on inactive tabs to "press" them down; active tab leaves bottom open
                    isActive
                    ...
                    isActive ? "before:absolute before:inset-x-0 before:top-0 before:h-1 before:bg-clay-500 before:content-['']" : "",
                  ].join(" ")}
                >
