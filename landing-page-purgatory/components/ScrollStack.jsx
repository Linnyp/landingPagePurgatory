...
const ScrollStack = ({
  ...
  useLayoutEffect(() => {
    ...
    // Cache natural offsets synchronously — cards only have translateZ(0) here
    // so getBoundingClientRect gives their true document position.
    const cacheOffsets = () => {
    ...
    const resizeObserver = new ResizeObserver(cacheOffsets);
