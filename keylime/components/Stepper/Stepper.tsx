...
// React Bits Stepper — adapted to TypeScript + the Citrus & Charcoal palette.
// Imports from framer-motion (the installed package) rather than `motion/react`.
...
function SlideTransition({
  ...
  useLayoutEffect(() => {
    ...
    // Re-measure when inner content changes height (e.g. a module's
    // "How we calculate this" expander opening/closing).
...
function StepIndicator({
  ...
  return (
    ...
    >
      <motion.div
        variants={{
          inactive: { scale: 1, backgroundColor: "#dcddd7", color: "#4f524b" },
          active: { scale: 1, backgroundColor: "#a4d639", color: "#1c1e1a" },
          complete: { scale: 1, backgroundColor: "#a4d639", color: "#1c1e1a" },
        }}
...
function StepConnector({ isComplete }: { isComplete: boolean }) {
  const lineVariants: Variants = {
    ...
    complete: { width: "100%", backgroundColor: "#a4d639" },
  };
